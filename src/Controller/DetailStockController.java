...
//    ArrayList<Kho> list;
    ...
    public void main(int id) throws SQLException {
        ...
        int menuItem;
        do {
            System.out.println("---------Quản Lý Chi Tiết Kho---------");
            menu();
            ...
            switch (menuItem) {
                ...
                case 0:
                    ...
                    break;
                default:
                    System.out.print("Xin mời nhập lại ,hãy nhập từ 0 đến 4 : ");
                    break;
            }
        } while (!quit);
    ...
    public void displayList(ArrayList<ChiTietKho> list) {
        if (list.size() <= 0) {
            ...
            for (ChiTietKho stock1 : list) {
                System.out.printf("%-20.20s%-20.20s%-20.20s%-20.20s\n", count, stock1.getId(), stock1.getMaKho(), stock1.getMaHang(), stock1.getSL());
                count++;
            }
